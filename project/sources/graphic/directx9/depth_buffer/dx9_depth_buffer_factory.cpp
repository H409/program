...
// using
//*****************************************************************************
using TBaseDepthBuffer = std::shared_ptr<base::depth_buffer::BaseDepthBuffer>;
...
// create
//=============================================================================
TBaseDepthBuffer DX9DepthBufferFactory::Create_(const u16 & in_width,const u16 & in_height,const base::depth_buffer::FORMAT& in_format)
{
