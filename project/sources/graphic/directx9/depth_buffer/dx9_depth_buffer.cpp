...
// constant definition
//*****************************************************************************
const base::depth_buffer::FORMAT DX9DepthBuffer::DEFAULT_FORMAT = base::depth_buffer::FORMAT::NONE;
...
// constructor
//=============================================================================
DX9DepthBuffer::DX9DepthBuffer(const u16& in_width,const u16& in_height,const base::depth_buffer::FORMAT& in_format,LPDIRECT3DDEVICE9 in_direct3ddevice9)
{
...
//=============================================================================
D3DFORMAT DX9DepthBuffer::ConvertD3DFORMATFromFormat_(const base::depth_buffer::FORMAT& in_format)
{
