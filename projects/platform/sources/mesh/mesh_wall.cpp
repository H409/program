...
// constant definition
//*****************************************************************************
const D3DCOLOR MeshWall::DEFAULT_COLOR = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f);
const D3DXVECTOR2 MeshWall::DEFAULT_POSITION = D3DXVECTOR2(0.0f, 0.0f);

//=============================================================================
// constructor
//=============================================================================
MeshWall::MeshWall(const u32& in_width_count, const u32& in_height_count)
	:MeshWall(1.0f, 1.0f, in_width_count, in_height_count)
{
}
...
// constructor
//=============================================================================
MeshWall::MeshWall(const f32& in_block_width, const f32& in_block_height, const u32& in_width_count, const u32& in_height_count)
	:Mesh(true, true)
...
// set index
//=============================================================================
void MeshWall::SetIndex(u32 x, u32 y, u32 indes)
{
...
void MeshWall::AttachRenderState_(void)
{
	auto directx9 = GET_DIRECTX9_DEVICE();
...
void MeshWall::DetachRenderState_(void)
{
	auto directx9 = GET_DIRECTX9_DEVICE();
...
//=============================================================================
void MeshWall::UpdateVertexBuffer_(void)
{
