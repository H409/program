...
//*****************************************************************************
namespace mesh {
	class MeshDome :public Mesh
	{
	public:
		// constructor
		MeshDome(const u32& in_width_count, const u32& in_height_count);
		MeshDome(const f32& in_block_width, const f32& in_block_height, const u32& in_width_count, const u32& in_height_count);
		//destructor
